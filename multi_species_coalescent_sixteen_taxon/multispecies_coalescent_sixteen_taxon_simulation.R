...
n_tips <- 16
species_tree <- "entire_tree_unbalanced.tre"
type <- "unbalanced"
...
entire_tree <- read.tree(species_tree)
...
dir.create(type)
dir.create(paste(type, "/", z, "_gene_sequences/", sep=""))

for (i in 1:length(file_names)){
write.phyDat(sequences[[i]], file = paste(type, "/", z, "_gene_sequences/", file_names[[i]], sep=""), format = "nexus")
}

dir.create(paste(type, "/", z, "_gene_trees/", sep=""))
for (i in 1:length(file_names)){
write.tree(gene_trees[[i]], file = paste(type, "/", z, "_gene_trees/", file_names[[i]], sep=""))
}
...
dir.create(paste(type, "/", z, "_concat_sequence/", sep=""))
write.phyDat(concat, file = paste(type, "/", z, "_concat_sequence/", "concat.nexus", sep=""), format = "nexus")
...
dir.create(paste(type, "/", z, "_clade_support", sep=""))
sink(paste(type, "/", z, "_clade_support/clade_support.txt", sep=""))
